...
export function ContactPage() {
    ...
    function onSubmit(contact: Contact) {
        ...
        navigate(`/thank-you/${contact.name.split(' ')[0]}`);
    }
        ...
        <div className="flex flex-col py-10 max-w-md mx-auto">
            ...
            <form noValidate onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className={fieldStyle}>
                    ...
                    <input type="email" id="email" className={getEditorStyle(errors.email)}
                        {...register('email', {
                            required: 'You must enter your email!',
                            pattern: {
                                value: /\S+@\S+\.\S+/,
                                message: 'entred value does not match email format',
                            }
                        })}
                    />
                ...
                <div className={fieldStyle}>
                    ...
                    <select id="reason" className={getEditorStyle(errors.reason)}
                        {...register('reason', {
